...
// ENU-confirmed presence. Names use the City's official neighbourhood labels;
// combined community-area responses are expanded to their mapped neighbourhoods.
const ENU_PUBLIC_CONTACT = "edmontonneighbourhoodsunited@gmail.com";
const ENU_PRESENCE_OVERRIDES = Object.freeze({
  ...
  "Parkallen": true,
  "Parkview": true,
  "Patricia Heights": true,
  "Pleasantview": true,
  "Queen Alexandra": true,
  "Queen Mary Park": true,
  "Quesnell Heights": true,
  "Rideau Park": true,
  "Rio Terrace": true,
  "Ritchie": true,
  "Royal Gardens": true,
  ...
  "Wedgewood Heights": true,
  "Wellington": true,
  "West Jasper Place": true,
  "West Meadowlark Park": true,
  "Westbrook Estates": true,
  "Westridge": true,
  "Windsor Park": true,
  "Wîhkwêntôwin": true,
  "Downtown": true,
...
async function buildRows() {
  ...
  const rows = neighbourhoods.flatMap(neighbourhood => {
    ...
    return [{
      ...
      leader: "",
      leaderEmail: presence === true ? ENU_PUBLIC_CONTACT : "",
      notes: ""
    }];
